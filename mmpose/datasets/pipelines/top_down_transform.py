...
class TopDownRandomFlip_Seg:
    ...
    def __call__(self, results):
        ...
        img = results['img']
        gt_seg_annotation = np.expand_dims(results['gt_semantic_seg'],axis=2)
        joints_3d = results['joints_3d']
        joints_3d_visible = results['joints_3d_visible']
        if 'center' in results:
            center = results['center']
        ...
        results['joints_3d'] = joints_3d
        results['joints_3d_visible'] = joints_3d_visible
        results['gt_semantic_seg'] = gt_seg_annotation
        if 'center' in results:
            results['center'] = center
        results['flipped'] = flipped
...
class TopDownAffine_Seg:
    ...
    def __call__(self, results):
        image_size = results['ann_info']['image_size']
        img = results['img']
        gt_seg_annotation = results['gt_semantic_seg']
